...
## Request Deletion or Data Export via Email
...
- Habit programs, daily check-ins, streaks, and measurements
- Journal entries, reflections, and uploads
- Notification preferences and device tokens

We retain only the minimal logs necessary to meet legal, fraud-prevention, and security obligations.

---

## Need Help?

If the in-app flow fails or you do not hear back after 2 business days, please email **support@thegreatlockinapp.com** so we can resolve the issue right away.

By submitting a deletion request, you understand the process is irreversible once completed.
